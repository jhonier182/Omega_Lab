...
public interface ProductService {
    ...
    BOMDTO createOrUpdateBOM(Integer productoId, BOMDTO bomDTO, Integer userId);
    BOMItemDTO addMaterialToBOM(Integer bomId, BOMItemDTO bomItemDTO);
    BOMDTO getBOMWithItems(Integer bomId);
    BOMItemDTO updateBOMItem(Integer itemId, BOMItemDTO bomItemDTO);
